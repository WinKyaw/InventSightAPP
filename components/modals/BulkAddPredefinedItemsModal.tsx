...
export function BulkAddPredefinedItemsModal({ visible, onClose, onSave }: BulkAddModalProps) {
  ...
  const handleSave = () => {
    ...
    const items = lines.map((line: string) => {
      ...
      // Optional fields
      // Note: SKU is auto-generated by backend, don't send it from frontend
      if (parts[3]) item.defaultprice = parts[3]; // Price in 4th position (lowercase to match backend)
      if (parts[4]) item.description = parts[4]; // Description in 5th position (optional)
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <TextInput
            ...
            placeholder={'Apples, Food, lb, 2.99\nBananas, Food, lb, 1.49\nMilk, Beverages, gal, 4.99, Fresh milk'}
